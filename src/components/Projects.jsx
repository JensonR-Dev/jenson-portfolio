        ...
        <div className="pf-progect-grid">
          <div className="pf-project-box">
            ...
            <h5 className="project-title">
              TeamApp -{" "}
              <span> A platform for managing your team efficiently.</span>
            </h5>
            <div className="project-cta">
              <a
                href="https://www.behance.net/gallery/218791673/TeamApp-Website"
                target="_blank"
              ...
              <a
                href="https://jenson-team-app.webflow.io/"
                target="_blank"
                className="live-cta"
              >
                View Page
          ...
          <div className="pf-project-box">
            ...
            <h5 className="project-title">
              ChatApp -{" "}
              <span>
                A friendly platform to connect with people anytime, anywhere!
              </span>
            </h5>
            <div className="project-cta">
              <a
                href="https://www.behance.net/gallery/206325195/ChatApp-Website-Design"
                target="_blank"
                className="behance-cta"
              >
                Behance
              ...
              <a
                href="https://chatapp-9b1274.webflow.io/"
                target="_blank"
                className="live-cta"
              >
                View Page
          ...
          <div className="pf-project-box">
            ...
            <h5 className="project-title">
              Linkup -{" "}
              <span>
                A fun and friendly platform to connect with friends anytime!
              </span>
            </h5>
            <div className="project-cta">
              <a
                href="https://www.behance.net/gallery/205274089/LiNKup-Messenger"
                target="_blank"
                className="behance-cta"
              >
                Behance
          ...
          <div className="pf-project-box">
            ...
            <h5 className="project-title">
              ...
              <span>
                {" "}
                A caring platform for your pet’s health and well-being!
              </span>
            </h5>
            <div className="project-cta">
              <a
                href="https://www.behance.net/gallery/218804349/VetCare-Website"
                target="_blank"
                className="behance-cta"
              >
                Behance
